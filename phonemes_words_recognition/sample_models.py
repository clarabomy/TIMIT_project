...
def rnn_model(input_dim, units, activation, phn=False):
...
def cnn_rnn_model(input_dim, filters, kernel_size, conv_stride,
	conv_border_mode, units, phn=False):
...
def cnn_deep_rnn_model(input_dim, filters, kernel_size, conv_stride,
	conv_border_mode, units, dropout_rate=0.5, number_of_layers=2, 
	cell=GRU, activation='tanh', phn=False):
