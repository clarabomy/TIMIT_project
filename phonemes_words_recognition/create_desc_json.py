...
def main(data_directory, output_file, result):
	labels = []
	durations = []
	keys = []
...
if __name__ == '__main__':
	...
	parser.add_argument('result', type=str, help='Word or phonemes? (wrd/pnh)')
	args = parser.parse_args()
	args.result=args.result.lower()
	if (args.result=="phn" or args.result=="phonemes"):
		result = "phn"
	elif(args.result=="wrd" or args.result=="words"):
		result="wrd"
	else:
		print("Last argument is wrong. Try 'wrd' or 'phn'.")
		result=None
	if result:
		main(args.data_directory, args.output_file, result)
